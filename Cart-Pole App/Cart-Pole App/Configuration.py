...
init_weights_bias_mean_val  = 1.0           # Mean value of the normal distribution used to initialize the weights and biases
init_weights_bias_std_dev   = 5.0           # Standard Deviation of the normal distribution used to initialize the weights and biases
